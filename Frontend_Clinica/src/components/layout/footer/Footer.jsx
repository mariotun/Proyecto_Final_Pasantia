            ...
            <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                <div className="col-md-4 d-flex align-items-center">
                    <a href="/" className="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-snow2" viewBox="0 0 16 16">
                    ...
                    <span className="mb-3 mb-md-0 text-muted">© 2022 Dental Clinic Smile,  Inc. All rights reserved.</span>
                </div>
